        ...
        <div className="app-card w-full max-w-2xl p-8 text-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Link
              ...
              className="app-btn app-btn-green py-4"
            >
              Se connecter
            </Link>
        ...
        <div className="app-card p-8 md:p-10">
          <div className="mb-8 flex items-start justify-between gap-4">
            <div>
              ...
              <p className="app-subtitle">Édition des correspondances</p>
            </div>
          ...
          <form method="GET" className="grid gap-6 md:grid-cols-2">
            ...
            <div className="md:col-span-2 grid gap-4 md:grid-cols-4 pt-2">
              ...
              <Link href="/correspondence/admin" className="app-btn app-btn-outline py-4">
                Réinitialiser
              </Link>
